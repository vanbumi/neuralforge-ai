...
import { FaChartLine, FaEye, FaHardHat, FaRobot, FaFileInvoice, FaMoneyBillWave, FaBoxes, FaChartPie } from 'react-icons/fa';
...
export const ModuleCard = ({ module, index }: ModuleCardProps) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-slate-800 mb-4">{desc}</p>
      <div className="bg-slate-100 rounded-xl p-4 text-sm font-mono text-slate-900 mb-4">
        <span className="font-semibold">📊 Alur:</span> {flow}
      </div>
      <div className="flex justify-between items-center">
        <span className="text-2xl font-bold text-teal-800">{price}</span>
